...
class CourseOutlineTool(Tool):
    """Tool for retrieving a course's complete outline from the catalog"""
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": "Get the complete outline of a course: its title, link, and numbered lesson list with titles",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_name": {
